...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Call SageMaker endpoint")
    parser.add_argument("--endpoint_name", type=str, required=True, help="Name of the endpoint to call")
